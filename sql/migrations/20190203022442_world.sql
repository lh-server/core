...
SET v = (SELECT COUNT(*) FROM `migrations` WHERE `id`='20190203022442');
IF v=0 THEN
INSERT INTO `migrations` VALUES ('20190203022442');
...
-- Skeram (15263)
-- --------------
-- Both item pools available in 1.9
UPDATE `creature_loot_template` SET `patch_min` = 7 WHERE `entry` = 15263 AND `item` = 30412;
